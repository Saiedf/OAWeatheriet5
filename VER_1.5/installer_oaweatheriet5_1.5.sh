...
#
# Telnet command:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/OAWeatheriet5/main/VER%201.5/installer_oaweatheriet5_1.5.sh" | /bin/sh
#
# Alternative command (download then run):
# wget -O /tmp/installer_oaweatheriet5_1.5.sh "https://raw.githubusercontent.com/Saiedf/OAWeatheriet5/main/VER%201.5/installer_oaweatheriet5_1.5.sh" && chmod 755 /tmp/installer_oaweatheriet5_1.5.sh && /bin/sh /tmp/installer_oaweatheriet5_1.5.sh
# ==========================================================
...
PACKAGE_NAME='enigma2-plugin-extensions-oaweatheriet5'

# Legacy/old package name fallback for older builds that used uppercase letters.
LEGACY_PACKAGE_NAME='enigma2-plugin-extensions-OAWeatheriet5'

# Display name used in messages only.
PLUGIN_TITLE='OAWeatheriet5'
...
DEB_DREAMBOX_PY2=''
DEB_DREAMBOX_PY3=''
DEB_DREAMOS_DEFAULT='enigma2-plugin-extensions-oaweatheriet5_1.5_all.deb'
...
IPK_OPENSOURCE_PY2=''
IPK_OPENSOURCE_PY3=''
IPK_OPENSOURCE_DEFAULT='enigma2-plugin-extensions-oaweatheriet5_1.5_all.ipk'
