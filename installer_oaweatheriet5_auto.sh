...
#
# Alternative:
# wget -O /tmp/installer_oaweatheriet5_auto.sh "https://raw.githubusercontent.com/Saiedf/OAWeatheriet5/main/installer_oaweatheriet5_auto.sh" && chmod 755 /tmp/installer_oaweatheriet5_auto.sh && /bin/sh /tmp/installer_oaweatheriet5_auto.sh
# ==========================================================
